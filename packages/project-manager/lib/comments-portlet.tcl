...
# @cvs-id $Id: comments-portlet.tcl,v 1.5 2005/12/14 17:51:19 maltes Exp $
...
set comments [general_comments_get_comments -print_content_p [parameter::get -parameter "PrintContentP" -default 1] -print_attachments_p [parameter::get -parameter "PrintAttachmentsP" -default 1] -print_user_info_p [parameter::get -parameter "PrintUserInfoP" -default 1] $project_item_id "[ad_conn url]?project_item_id=$project_item_id"]
