...
set exporting_vars { status_id category_id assignee_id projects_orderby format pm_status_id pm_contact_id pm_etat_id previous_status_f current_package_f subprojects_p }
