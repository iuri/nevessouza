...
ad_page_contract {
    ...
    @cvs-id $Id: item-stats.tcl,v 1.12 2018/07/17 13:32:18 hectorr Exp $
} {
...
template::multirow foreach sections {
    db_foreach items {
        select i.as_item_id, i.subtext, ci.item_id, cr.title, cr.revision_id,
               cr.content as question_text, cr.description, i.field_name,
               asr.item_id as as_item_id_i, ism.required_p, ism.section_id,
               ism.sort_order, ism.max_time_to_complete, ism.points, i.data_type
