...
ad_form -name "your_zen_level" -method post -html {enctype multipart/form-data class vertical-form} -fieldset {{title "T1" class "C1"} \
														 "<b>Form using vertical-form class</b>"} \
    -form {
    {zen_id:key}
